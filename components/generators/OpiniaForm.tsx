...
const SHARED_KEYS = new Set(['nazwaFirmy', 'daneKontaktowe'])

const FIRMA_KEYS = new Set(['nazwaFirmy'])
...
interface OpiniaFormProps {
  activeTemplateId: OpiniaTemplateId
...
export default function OpiniaForm({ activeTemplateId, onGenerate }: OpiniaFormProps) {
  const [fields, dispatch] = useReducer(reducer, {})
  const prevTemplateRef = useRef<OpiniaTemplateId>(activeTemplateId)
  ...
  const template = opiniaTemplates[activeTemplateId]
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    pushEvent('pismo_generated', { pismo_type: 'opinia', template: activeTemplateId })
    onGenerate(doc)
  }
